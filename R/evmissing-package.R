...
#'   1996-2024. See also [`LaPlagnePrecipMaxima`], [`LaPlagneSnowMaxima`],
#'   [`LaPlagnePrecipMaximaSeasonal`], [`LaPlagneSnowMaximaSeasonal`],
#'   [`LaPlagnePrecipMissings`], [`LaPlagneSnowMissings`].
#'
