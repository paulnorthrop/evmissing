...
plot(fit_adjust)
```    
```{r plots, echo = FALSE, imgcenter = TRUE, fig.width = 5, fig.height = 5, out.width="60%", alt = "Diagnostic plots of for the Brest Sea Surge Maxima data. PP, QQ, return level and density plots."}
```    
